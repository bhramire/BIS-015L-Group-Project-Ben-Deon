...
server <- function(input, output, session) {
  ...
  output$plot <- renderPlot({
    ...
    south_america %>% 
      ...
      labs(x= "Countries", y= "Number of Deaths", fill= "Country", title= "Number of Deaths per Country for each Cause of Death")
  ...
  geom_col(fill = "deepskyblue4")+
      theme_light() +
      theme(axis.text.x = element_text(angle = 60, hjust = 1))+
      labs(x= "Year", y= "Number of Deaths", title = "Number of Deaths over the Years for each Cause of Death and Country")
  ...
  geom_line()+
      ...
      labs(x= "Years", y= "Number of Deaths", color="Causes", title= "Deaths Yearly Sorted by Cause per Country")
